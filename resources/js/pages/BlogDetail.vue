                ...
                <div class="container">
                    <div class="_2-column-block-top">
                                    ...
                                    <div role="list" class="featured-properties-wrapper w-dyn-items">
                                        <div role="listitem" class="w-dyn-item" v-for="popularBlog in popularBlogs" :key="popularBlog.id">
                                            <div class="featured-blogs">
                                                <a :href="`/blog/${popularBlog.slug}`" class="mask related-post w-inline-block"
                                                    ><img alt="" loading="lazy" width="70" :src="popularBlog.image" class="featured-image" /></a
                                                ><a :href="`/blog/${popularBlog.slug}`" class="mask w-inline-block"
                                                    ><div class="post-title">{{ popularBlog.title }}</div></a
                                                >
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            data-aos-delay="200"
                        >
                            <img loading="lazy" width="70" :src="blog.image" alt="" class="post-image" data-aos="zoom-in" data-aos-delay="300" />
                            ...
                            <div class="rich-text-block w-richtext" data-aos="fade-up" data-aos-delay="500" v-html="blog.content"></div>
                            ...
                            <div class="tag-block" data-aos="fade-up" data-aos-delay="1000">
                                ...
                                <div class="tag-block">
                                    ...
                                    <div class="social-share-icon-container">
                                        ...
                                        ></a>
                                        <a
                                            :href="`https://www.pinterest.com/pin/create/button/?url=${pageUrl}&media=${blog.image}&description=${blog.title}`"
                                            target="_blank"
                                            class="social-share-icon pinterest"
                                        ></a>
                                    </div>
                                </div>
                            </div>
