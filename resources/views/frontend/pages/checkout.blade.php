...
@section('title','COCOLUX || Checkout page')
                            ...
                            <div class="content">
                                <ul>
                                    ...
                                    <li class="shipping">
                                        ...
                                        class="shippingOption" data-price="{{$shipping->price}}">{{$shipping->type}}:
                                    ...
                                    {{--                                            @endphp--}}
                                    {{--                                            @if(session('coupon'))--}}
                                    {{--                                                <li class="last"  id="order_total_price">Total<span>${{number_format($total_amount,2)}}</span>
                                    </li>--}}
                                    {{--                                            @else--}}
                                    {{--                                                <li class="last"  id="order_total_price">Total<span>${{number_format($total_amount,2)}}</span>
                                    </li>--}}
                        ...
                        <div class="single-widget">
                            ...
                            <div class="content">
                                <div class="checkbox">
                                    ...
                                    <form-group>
                                        <input name="payment_method" checked type="radio" value="cod"> <label> Cash On
                                            Delivery</label><br>
                                    </form-group>
